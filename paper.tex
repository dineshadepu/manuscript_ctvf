...
\begin{figure}[!htpb]
  \centering
  % \includegraphics[width=1\linewidth]{figures/free_surface_identification_demonstration/normals_dam_break_final_zoomed}
...
\begin{figure}[!htpb]
  \centering
  % \includegraphics[width=1\linewidth]{figures/free_surface_identification_demonstration/boundary_particles_final_zoomed}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{images/pst_free_surf/pst_free_surface}
    \includegraphics[width=1\linewidth]{fig_5_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.1\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{images/pst_free_surf/pst_free_surface_zoomed}
    \includegraphics[width=1\linewidth]{fig_5_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green/tg_decay}
    \includegraphics[width=1\linewidth]{fig_6_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green/tg_l1}
    \includegraphics[width=1\linewidth]{fig_6_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green/tg_decay_ipst}
    \includegraphics[width=1\linewidth]{fig_7_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green/tg_l1_ipst}
    \includegraphics[width=1\linewidth]{fig_7_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_re_1000/tg_decay_ipst}
    \includegraphics[width=1\linewidth]{fig_8_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_re_1000/tg_l1_ipst}
    \includegraphics[width=1\linewidth]{fig_8_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_re_1000/tg_decay}
    \includegraphics[width=1\linewidth]{fig_9_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_re_1000/tg_l1}
    \includegraphics[width=1\linewidth]{fig_9_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_sun2019_corrections_test/tg_l1_re_100}
    \includegraphics[width=1\linewidth]{fig_10_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_sun2019_corrections_test/tg_l1_re_1000}
    \includegraphics[width=1\linewidth]{fig_10_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_ipst_corrections_test/tg_l1_re_100}
    \includegraphics[width=1\linewidth]{fig_11_a}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1\linewidth]{figures/taylor_green_ipst_corrections_test/tg_l1_re_1000}
    \includegraphics[width=1\linewidth]{fig_11_b}
    \subcaption{}%
...
\begin{figure}[!htpb]
  \centering
  % \includegraphics[width=0.5\linewidth]{figures/taylor_green_re_1000/tg_pplot_p_re_1000}
...
It has been simulated by \cite{Adami2013}, \cite{huang_kernel_2019},
\cite{edac-sph:cf:2019} to note a few. A rectangular cavity with length 1 m
...
\begin{figure}[!htpb]
  \centering
  % \includegraphics[width=1\linewidth]{figures/cavity_sun2019_corrections_test/good_vs_bad}
...
time against \cite{koshizuka1996moving}, where the authors use the moving
...
\begin{figure}[!htpb]
  ...
  % \includegraphics[width=\textwidth]{figures/dam_break_2d/db2d_vmag}
...
while extending the transport velocity formulation~\cite{Adami2013} scheme to
more particle shifting techniques. We consider a thin oscillating
plate that is clamped on one side. \citet{landau1960} provide an analytical
solution for this problem. This is also simulated numerically in
\cite{gray-ed-2001} and \cite{zhang_hu_adams17}.
...
kg\,m\textsuperscript{-3}, as done in~\cite{gray-ed-2001}.  In all the cases
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.3975/time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:sun2019-nu-0.3975-0}
  % \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.3975/time1}
    \includegraphics[width=1\linewidth]{fig_25_a}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:sun2019-nu-0.3975-1}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.3975/time2}
    \includegraphics[width=1\linewidth]{fig_25_b}
    \subcaption{t = 4e-03 sec}\label{fig:rings:sun2019-nu-0.3975-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.3975/time3}
    \includegraphics[width=1\linewidth]{fig_25_c}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:sun2019-nu-0.3975-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.3975/time4}
    \includegraphics[width=1\linewidth]{fig_25_d}
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:sun2019-nu-0.47-0}
  % \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time1}
    \includegraphics[width=1\linewidth]{fig_26_a}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:sun2019-nu-0.47-1}
  \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time2}
    \includegraphics[width=1\linewidth]{fig_26_b}
    \subcaption{t = 4e-03 sec}\label{fig:rings:sun2019-nu-0.47-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time3}
    \includegraphics[width=1\linewidth]{fig_26_c}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:sun2019-nu-0.47-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time4}
    \includegraphics[width=1\linewidth]{fig_26_d}
    \subcaption{t = 1.45e-02 sec}\label{fig:rings:sun2019-nu-0.47-4}
  \end{subfigure}
  %
%   \begin{subfigure}{0.3\textwidth}
%     \centering
%     \includegraphics[width=1.0\textwidth]{figures/rings/etvf_sun2019_poisson_ratio_0.47/time5}
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:ipst-nu-0.47-0}
  % \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time1}
    \includegraphics[width=1\linewidth]{fig_27_a}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:ipst-nu-0.47-1}
  \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time2}
    \includegraphics[width=1\linewidth]{fig_27_b}
    \subcaption{t = 4e-03 sec}\label{fig:rings:ipst-nu-0.47-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time3}
    \includegraphics[width=1\linewidth]{fig_27_c}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:ipst-nu-0.47-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time4}
    \includegraphics[width=1\linewidth]{fig_27_d}
    \subcaption{t = 1.45e-02 sec}\label{fig:rings:ipst-nu-0.47-4}
  \end{subfigure}
  %
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures/rings/etvf_ipst_poisson_ratio_0.47/time5}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.3\textwidth}
    ...
    \subcaption{t = $0 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    ...
    \subcaption{t = $1 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time2}
    \includegraphics[width=1\linewidth]{fig_30_c}
    \subcaption{t = $2 \times 10^{-6}$ sec}\label{}
  \end{subfigure}

  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time3}
    \includegraphics[width=1\linewidth]{fig_30_d}
    \subcaption{t = $3 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time4}
    \includegraphics[width=1\linewidth]{fig_30_e}
    \subcaption{t = $4 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time5}
    \includegraphics[width=1\linewidth]{fig_30_f}
    \subcaption{t = $5 \times 10^{-6}$ sec}\label{}
  \end{subfigure}

  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time6}
    \includegraphics[width=1\linewidth]{fig_30_g}
    \subcaption{t = $6 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    % \includegraphics[width=1.0\textwidth]{figures/high_velocity_impact/etvf_sun2019/time7}
    \includegraphics[width=1\linewidth]{fig_30_h}
    \subcaption{t = $7 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    ...
    \subcaption{t = $8 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
