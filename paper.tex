...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f0_circle_geometry_normals}
    \subcaption{}%
...
%%%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f0_circle_geometry}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f0_circle_with_boundary_normals}
    \subcaption{}%
...
%%%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f0_circle_with_boundary}
    \subcaption{}%
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=1\linewidth]{f0_normals_dam_break_final_zoomed}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=1\linewidth]{f0_boundary_particles_final_zoomed}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{im0}
    \subcaption{}%
...
%
  \begin{subfigure}{0.1\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{im0_zoomed}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{ft1_decay}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{ft1_l1}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{ft1_decay_ipst}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{ft1_l1_ipst}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f01_1000_tg_decay_ipst}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f01_1000_tg_l1_ipst}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f01_1000_tg_decay}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{f01_1000_tg_l1}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{fs1_tg_l1_re_100}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{fs1_tg_l1_re_1000}
    \subcaption{}%
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{fi1_tg_l1_re_100}
    \subcaption{}%
...
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{fi1_tg_l1_re_1000}
    \subcaption{}%
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.5\linewidth]{f01_1000_tg_pplot_p_re_1000}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=1\linewidth]{f2_good_vs_bad}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.5\linewidth]{figures_cavity_uv_re100}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.5\linewidth]{figures_cavity_uv_re1000}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{f3_x_vs_t}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=\textwidth]{figures_dam_break_2d_db2d_vmag}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{f4_gtvf_original}
    \subcaption{}%
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{f4_sun2019}
    \subcaption{}%
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{f5_l_0_2_h_0_02}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{f5_l_0_2_h_0_01}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{f6_ipst}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.7\textwidth]{figures_oscillating_plate_ipst_convergence_plot}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.4\textwidth]{im1_uniaxial_compression}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.8\textwidth]{f7_von_mises_A}
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures_rings_etvf_sun2019_poisson_ratio_0.3975_time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:sun2019-nu-0.3975-0}
  % \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_3975_time1}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:sun2019-nu-0.3975-1}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_3975_time2}
    \subcaption{t = 4e-03 sec}\label{fig:rings:sun2019-nu-0.3975-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_3975_time3}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:sun2019-nu-0.3975-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_3975_time4}
    \subcaption{t = 1.45e-02 sec}\label{fig:rings:sun2019-nu-0.3975-4}
  \end{subfigure}
% %
%   \begin{subfigure}{0.3\textwidth}
%     \centering
%     \includegraphics[width=1.0\textwidth]{figures_rings_etvf_sun2019_poisson_ratio_0.3975_time5}
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures_rings_etvf_sun2019_poisson_ratio_0.47_time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:sun2019-nu-0.47-0}
  % \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_47_time1}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:sun2019-nu-0.47-1}
  \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_47_time2}
    \subcaption{t = 4e-03 sec}\label{fig:rings:sun2019-nu-0.47-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_47_time3}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:sun2019-nu-0.47-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f8_0_47_time4}
    \subcaption{t = 1.45e-02 sec}\label{fig:rings:sun2019-nu-0.47-4}
  \end{subfigure}
  %
%   \begin{subfigure}{0.3\textwidth}
%     \centering
%     \includegraphics[width=1.0\textwidth]{figures_rings_etvf_sun2019_poisson_ratio_0.47_time5}
...
\begin{figure}[!htpb]
  ...
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures_rings_etvf_ipst_poisson_ratio_0.47_time0}
  %   \subcaption{t = 0 sec}\label{fig:rings:ipst-nu-0.47-0}
  % \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f9_0_47_time1}
    \subcaption{t = 2.5e-03 sec}\label{fig:rings:ipst-nu-0.47-1}
  \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f9_0_47_time2}
    \subcaption{t = 4e-03 sec}\label{fig:rings:ipst-nu-0.47-2}
  \end{subfigure}

  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f9_0_47_time3}
    \subcaption{t = 7.3e-03 sec}\label{fig:rings:ipst-nu-0.47-3}
  \end{subfigure}
%
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f9_0_47_time4}
    \subcaption{t = 1.45e-02 sec}\label{fig:rings:ipst-nu-0.47-4}
  \end{subfigure}
  %
  % \begin{subfigure}{0.3\textwidth}
  %   \centering
  %   \includegraphics[width=1.0\textwidth]{figures_rings_etvf_ipst_poisson_ratio_0.47_time5}
...
\begin{figure}[!htpb]
  \centering
  \includegraphics[width=0.4\textwidth]{images_rings_rings_initial}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f10_a_b_0_3975_x}
    \subcaption{$x$ coordinate of the point A}\label{fig:rings-compare-x}
  \end{subfigure}
  %
  \begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f10_a_b_0_3975_y}
...
\begin{figure}[!htpb]
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time0}
    \subcaption{t = 0 sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time1}
    \subcaption{t = $1 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time2}
    \subcaption{t = $2 \times 10^{-6}$ sec}\label{}
  \end{subfigure}

  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time3}
    \subcaption{t = $3 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time4}
    \subcaption{t = $4 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time5}
    \subcaption{t = $5 \times 10^{-6}$ sec}\label{}
  \end{subfigure}

  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time6}
    \subcaption{t = $6 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time7}
    \subcaption{t = $7 \times 10^{-6}$ sec}\label{}
  \end{subfigure}
%
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{f11_time8}
